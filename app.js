...
const mbtiData = {
  INTJ: {
    deepAnalysis: "你以為我盯著天花板發呆？其實我正在腦中建構這張嬰兒床的結構應力圖，並計算最佳的越獄路徑。我不太愛無意義的假哭，眼淚對我來說是拿來跟大人談判的籌碼。比起花花綠綠、只會發出吵鬧聲的聲光玩具，我更喜歡安靜地觀察光影變化和大人們的行為模式。這個家目前的動線設計有點差，等我會走路了，我會親自把所有玩具重新歸位，建立一套屬於我的高效系統。至於我長大後的可能性，請爸媽做好心理準備。上了幼兒園，我絕對不會跟著大家盲目搶溜滑梯，我會精準計算出人潮最少的黃金時段。上了學，我大概會是那個在小組報告裡默默分配好所有任務，然後自己搞定最困難核心架構的冷面學霸。我不喜歡廢話，但我做出的決策通常都是最完美的。未來，我絕對是能在幕後運籌帷幄、制定改變世界規則的狠角色。",
  ...
  INTP: {
    deepAnalysis: "說明書？那是給凡人看的。拿到新玩具的第一步，當然是把它徹底拆解，看看裡面的齒輪到底是怎麼運作的。我有時候會突然看著空氣笑出來，那是因為我腦中剛剛推演完了一個極具創意的宇宙理論（雖然我現在只會流口水）。我對日常瑣事例如按時睡覺毫無興趣，但請千萬不要打斷我研究這根羽毛飄落軌跡的偉大實驗，這可是關係到物理學的發展！說到長大後的可能性，我的大腦就是一台沒有極限的超級電腦。等我學會拿螺絲起子，家裡的微波爐跟遙控器可能都會被我拆了來升級我的玩具車。在學校裡，我可能常常忘記帶聯絡簿、討厭死板的背誦科，但卻能在科學展覽上拿出現場所有老師都看傻眼的破格發明。我的人生不在乎世俗的眼光和無聊的社交，我只追求宇宙運作的終極真理與知識的極限。",
  ...
  ENTJ: {
    deepAnalysis: "從我出生的那一刻起，我就決定要接管這個家了。我哭聲嘹亮絕對不是因為害怕，我這是在發號施令！我清楚知道自己要什麼，不管是特定的安撫巾還是那個放在高處的積木，我不達目的絕不罷休。旁邊那個正在搶玩具的嬰兒真是不講武德，等我正式掌權了，我一定會為這座公園的沙坑制定一套完善的管理規則，讓所有人乖乖聽話，高效率地堆沙堡。關於長大後的發展，你們大概可以想像家裡住了一個迷你版的 CEO。小學三年級我可能就會在班上創辦自己的文具租賃帝國，並且把零用錢的投資報酬率算得清清楚楚。遇到分組活動時，如果隊友太雷，我會毫不猶豫地接過指揮棒帶領全隊殺出重圍。我不害怕衝突，我只在乎目標有沒有達成，未來絕對是個能在商場或職場上叱吒風雲、帶領大軍前進的頂級領袖人物。",
  ...
  ENTP: {
    deepAnalysis: "規矩是什麼？好吃嗎？我每天最重要的任務就是挑戰你們的底線，看看這個世界的極限到底在哪裡！我超級喜歡引起大人的注意，只要你們露出崩潰或驚訝的表情，我的搗蛋實驗就成功了！我學東西超快，但喜新厭舊的速度更快，上一秒還是最愛的恐龍模型，下一秒就被我拿去測試馬桶的沖水威力了。請隨時保持警戒，因為我永遠有新花招。預言一下我長大後的樣子吧！我絕對會是那個在課堂上用各種刁鑽問題把老師問到懷疑人生的鬼靈精。我討厭一成不變的讀書方法，我會發明出自己獨套的速成記憶法。到了青春期，我可能是學校辯論社的社長，能把黑的說成白的，把死的說成活的。我的大腦永遠在尋找下一個刺激的點子，從不甘於平凡，未來必定是個能打破行業規則的超級創新者與跨界人才。",
...
const zodiacData = {
  牡羊座: {
    NT: '自帶「閃電戰略」天賦，想到什麼戰術立刻執行，是個極具侵略性與效率的冷酷小霸主。',
    NF: '熱情如火的理想主義者，看到別的寶寶被欺負絕對第一個衝上去擋，正義感爆棚。',
    SJ: '家裡的熱血風紀股長，不僅自己守規矩，還會大聲喝斥旁邊不守規矩的大人。',
    SP: '裝了渦輪引擎的破壞王，完全沒有「害怕」這兩個字，極限運動員的最佳潛力股。'
  },
  金牛座: {
    NT: '固執的真理追求者。只要他認定這個積木該放這裡，就算天塌下來他也絕對不妥協。',
    NF: '極度重視五感體驗的浪漫派，對好聽的音樂、好摸的安撫巾有著難以割捨的執念。',
    SJ: '穩定度 100% 的天使寶寶。作息像生理時鐘一樣精準，只要吃飽睡好，就是全天下最乖的孩子。',
    SP: '佛系享樂主義者，平時懶洋洋，但看到喜歡的食物或閃亮的玩具，身手會瞬間變得極度靈活。'
  },
  雙子座: {
    NT: '大腦運算速度極快的超級駭客，會用各種牙牙學語和假動作來測試大人的智商底線。',
    NF: '天生自帶公關魂，在嬰兒車裡就能靠著豐富的表情跟路過的陌生人聊上十分鐘。',
    SJ: '喜歡收集情報的八卦小站。雖然守規矩，但眼睛總是在觀察家裡每個人的動靜。',
    SP: '專注力只有三秒鐘的好奇寶寶。需要同時給他五種不同的玩具，才能勉強讓他安靜一會兒。'
  },
  巨蟹座: {
    NT: '用堅硬的外殼保護著極度聰明的大腦。他不會主動挑起爭端，但在暗中早已掌控了一切資源。',
    NF: '共情能力點滿的終極暖寶，只要媽媽假裝哭泣，他絕對會立刻爬過來給你一個大大的擁抱。',
    SJ: '極度戀家的終極守護神。只要在熟悉的環境、熟悉的味道裡，他就是最可靠的貼心小棉襖。',
    SP: '情緒起伏較大的小藝術家。上一秒還在開心地玩水，下一秒可能因為泡泡破掉而感傷落淚。'
  },
  獅子座: {
    NT: '不怒自威的小國王。不需要哭鬧，只要一個眼神，大人就會乖乖把奶瓶跟玩具奉上。',
    NF: '自帶鎂光燈的太陽神。最喜歡在聚光燈下照顧別人，享受大家崇拜與感激的目光。',
    SJ: '極度傲嬌的模範生。只要你用力誇獎他守規矩，他就會為了維持面子而表現得更加完美。',
    SP: '天生的舞台巨星。人越多越嗨，只要有掌聲，他甚至能為你表演後空翻（雖然現在只會翻身）。'
  },
  處女座: {
    NT: '完美主義的數據精算師。對奶嘴的角度、衣服的摺痕有著近乎病態的邏輯要求。',
    NF: '心思極度細膩的奉獻者。會默默記住爸媽喜歡什麼，用最不張揚的方式表達他的愛。',
    SJ: '家裡的品管大師。任何東西只要不在原位，或是稍微有點髒污，他絕對會崩潰給你看。',
    SP: '擁有工匠精神的手作大師。只要給他積木，他能不吃不喝坐在那裡，排出對稱且完美的幾何圖形。'
  },
  天秤座: {
    NT: '絕對客觀的小法官。不偏袒任何人，只看證據說話，從小就展現出令人畏懼的談判技巧。',
    NF: '愛好和平的氣氛製造機。極度討厭衝突，只要家裡有人大聲說話，他就會試圖用笑聲來打圓場。',
    SJ: '重視公平的秩序維護者。「一人一半，感情不散」是他的座右銘，分餅乾絕對要精準對半。',
    SP: '極具美感的外貌協會會長。對醜的衣服或玩具會展現出明顯的嫌棄，天生擁有絕佳的審美品味。'
  },
  天蠍座: {
    NT: '看透一切的幕後黑手。你以為你在逗他玩？其實是他正在冷靜地分析你的行為模式。',
    NF: '愛恨分明的靈魂伴侶。他給你的愛是極致且獨佔的，但如果你騙了他，他會記仇到上小學。',
    SJ: '忠誠度破表的護衛犬。外表高冷難以接近，但一旦認定你是自己人，他會用生命去守護你。',
    SP: '神祕又危險的冒險王。越是禁止他去的地方，他越要趁你轉身時悄悄潛入，尋找刺激。'
  },
  射手座: {
    NT: '大腦停不下來的哲學家。喜歡探索抽象的規律，嬰兒床根本關不住他那渴望真理的自由靈魂。',
    NF: '無可救藥的樂天派。就算跌倒了也會大笑著爬起來，他的快樂具備著感染全家人的魔法。',
    SJ: '難得活潑的乖寶寶。雖然還是會遵守家規，但他總能用最幽默、最歡樂的方式去執行任務。',
    SP: '真正的脫韁野馬。只要門沒關緊，他絕對已經爬到院子裡去跟野貓打架了，體力深不見底。'
  },
  摩羯座: {
    NT: '野心勃勃的企業家寶寶。從一歲就開始規劃人生藍圖，每一個動作都有著明確的長期目標。',
    NF: '最接地氣的理想主義者。雖然充滿愛，但他的愛非常實際（例如把你掉在地上的餅乾撿起來塞給你）。',
    SJ: '比大人還像大人的老靈魂。你不需要操心他的作息，他可能會反過來提醒你到了該睡覺的時間。',
    SP: '披著乖巧外皮的行動派。平時不露聲色，但只要鎖定目標，他會展現出驚人的毅力和執行力。'
  },
  水瓶座: {
    NT: '降臨地球的外星天才。完全不按牌理出牌，你永遠無法用地球人的邏輯去預測他下一步要幹嘛。',
    NF: '博愛精神的倡議者。對他來說，家裡的狗、窗外的鳥和爸爸媽媽都一樣重要，眾生皆平等。',
    SJ: '守著一套奇怪規矩的怪咖。他不遵守大人的規矩，但他有自己一套絕對不能被打破的奇葩儀式感。',
    SP: '反叛精神點滿的改革者。你越叫他往東，他絕對往西，甚至還會發明一種全新往西的交通工具。'
  },
  雙魚座: {
    NT: '具備強大直覺的預言家。雖然滿腦子邏輯，但偶爾會冒出令人毛骨悚然、卻又極度精準的第六感。',
    NF: '自帶柔焦濾鏡的夢幻精靈。活在童話故事裡，對情緒極度敏感，看著一片落葉都能發呆半天。',
    SJ: '最溫柔的順從者。極度沒有攻擊性，只要你語氣溫和地引導，他就會乖乖配合所有的指令。',
    SP: '如水一般自由的舞者。身體極度柔軟靈活，沒有任何框架能困住他，充滿了令人著迷的藝術氣息。'
  }
};
