...
const uiTranslations = {
  zh: {
    ...
    roundInterest: '第一關｜星塵召喚',
    roundAbility: '第二關｜天賦顯影',
    roundPersonality: '第三關｜靈魂映照',
    roundInterestDesc: '先看看哪一件魔法道具最先吸引寶貝，追蹤他心中的第一道星光。',
    roundAbilityDesc: '從寶貝自然流露的反應裡，找出藏在小宇宙中的能力線索。',
    roundPersonalityDesc: '最後解讀寶貝與世界互動的氣質與節奏，拼出專屬的魔法人格圖譜。',
    selectedPrefix: '已選擇：',
    notSelected: '尚未選擇',
  ...
  en: {
    ...
    roundInterest: 'Round 1 | Starlight Calling',
    roundAbility: 'Round 2 | Gift Awakening',
    roundPersonality: 'Round 3 | Soul Echo',
    roundInterestDesc: 'See which enchanted object first captures your baby’s attention and reveals their first spark of wonder.',
    roundAbilityDesc: 'Follow your baby’s natural responses to uncover the hidden talents glowing inside their little universe.',
    roundPersonalityDesc: 'Read the rhythm of how your baby meets the world and reveal their unique magical personality pattern.',
